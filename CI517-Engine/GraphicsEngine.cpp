...
void GraphicsEngine::setDrawColor(Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
    drawColor = { r, g, b, a };
...
SDL_Texture* GraphicsEngine::createTextTexture(const std::string& text, const SDL_Color& color, TTF_Font* font) {
...
void GraphicsEngine::drawTexture(SDL_Texture* texture, SDL_Rect* src, SDL_Rect* dst) {
